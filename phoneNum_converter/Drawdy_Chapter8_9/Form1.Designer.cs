namespace Drawdy_Chapter8_9
{
    partial class Form1
    {
        ...
        private System.Windows.Forms.Label lblTitle; ///<summary>Label to display the title of the form.</summary>
        private System.Windows.Forms.TextBox txtNumber; ///<summary>TextBox for user to input the telephone number.</summary>
