...
namespace Drawdy_Exam2
{
    ...
    public partial class Form1 : Form
    {
        ...
        /// Adds grape soda to the total if available and updates the quantity.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="EventArgs"/> instance containing the event data.</param>
        ...
        /// Adds orange soda to the total if available and updates the quantity.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="EventArgs"/> instance containing the event data.</param>
        ...
        /// Adds cream soda to the total if available and updates the quantity.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="EventArgs"/> instance containing the event data.</param>
        ...
        /// Adds regular cola to the total if available and updates the quantity.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="EventArgs"/> instance containing the event data.</param>
        ...
        /// Adds cherry cola to the total if available and updates the quantity.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="EventArgs"/> instance containing the event data.</param>
